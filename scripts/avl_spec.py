    ...
    "spec": {
        ...
        "dataSchema": {
            ...
            "parser": {
                ...
                "parseSpec": {
                    "format": "csv",
                    "columns": ["cd_evento_avl_movto", "cd_linha", "dt_movto", "nr_identificador", "nr_evento_linha",
                                "nr_ponto",
                                ...
                                "nr_tipo_veiculo_geo", "cd_avl_conexao", "cd_prefixo"],
                    "dimensionsSpec": {
                        "dimensions": ["cd_evento_avl_movto", "dt_movto", "nr_identificador", "nr_evento_linha",
                                       "nr_ponto",
                                       "nr_evento_terminal_dado", "nr_evento_es_1", "nr_latitude_grau",
                                       "nr_longitude_grau", "nr_indiceregistro",
                                       "nr_tipo_veiculo_geo", "cd_avl_conexao", "cd_prefixo"]
                    },
                    "timestampSpec": {
                        "format": "auto",
